...
function Mypage(props) {
  ...
  let post_list = useSelector((state) => state.Product_.prdItem.Items);
  let post = !post_list ? [] : post_list;

  let mypage_list = useSelector((state) => state.userInfo.list);
  let mypageListID = !mypage_list.mypostDNO
    ? []
